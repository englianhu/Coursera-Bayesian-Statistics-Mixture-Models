...
<span style='color:Green;'>**正解** : $E(X)=0.2×0+0.5×1+0.3×2=1.1$</span>
...
こちらに回答を入力 <span style='color:Red;'>*`1.060159`, `0.07962572`</span>

<span style='color:Red;'>**不正解** : 
Recall that
$$Var(X) = E(X^2) - [E(X)]^2$$
...
3. The component are ordered based on the values of their means, i.e., the component with the smallest $\mu_k$ is labeled component 1, the one with the second smallest $\mu_k$ is labeled component 2, etc. (1点)
