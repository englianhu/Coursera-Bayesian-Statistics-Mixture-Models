...
```{r global_options, class.source = 'hover-input', class.output = 'hover-output'}
## https://stackoverflow.com/a/36846793/3806250
options(width = 999)
knitr::opts_chunk$set(class.source = 'hover-input', class.output = 'hover-output', class.error = 'hover-error')
```
